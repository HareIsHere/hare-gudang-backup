...
export default function MutationsIndex({
    mutations,
}: {
            ...
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400">
                        A comprehensive history of all inventory movements
                        including stock-ins, fulfillments, and transfers.
                    </p>
                </div>
...
function MutationTypeBadge({ type }: { type: string }) {
    ...
    return (
        <Badge
            variant="outline"
            className={`${colors[type] || ''} border px-2 py-0.5 text-[10px] font-bold tracking-wider`}
        >
            {type}
        </Badge>
    );
